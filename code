...
client = wolframalpha.Client('xxxxxxxxxxxxxxx')

folder = 'C:\\Users\\xxxx\\Downloads\\pirates BGM\\'

engine = pyttsx3.init()
voices = engine.getProperty('voices')

b_music = ['PiratesOfTheCaribbeanBgmRingtone785834948']
pygame.mixer.init()
...
class Widget:
    def __init__(self):
       ...
       root.resizable(0, 0)
       img = ImageTk.PhotoImage(Image.open(r"C:\Users\xxxx\Downloads\pirates BGM\pirates.jpg"))
       ...
       compFrame = LabelFrame(root, text="RIYA", font=('Black ops one', 10, 'bold'))
       ...
       speak('Hello, I am Riya! What should I do for You?')
